...
public class MSSegmentControl: UIControl {
  ...
  /// Default is `[UIColor whiteColor]`
    ...
    private var _backgroudColor = UIColor.white;
  override open dynamic var backgroundColor: UIColor! {
    set {
        self._backgroudColor = newValue
    }
    get {
        return self._backgroudColor;
    }
  }
  ...
  override open func draw(_ rect: CGRect) {
    ...
    selectionIndicatorRoundedLayer.backgroundColor = selectionIndicatorColor.cgColor
...
//                titleLayer.truncationMode = .end
  ...
  private func setRoundedFrame() {
    selectionIndicatorRoundedLayer.frame = self.frameForSelectionIndicator();
    selectionIndicatorRoundedLayer.cornerRadius = self.selectionIndicatorRoundedLayer.frame.height / 2.0;
    selectionIndicatorRoundedLayer.masksToBounds = true
  }
  ...
  public func setSelected(forIndex index: Int, animated: Bool, shouldNotify: Bool) {
    ...
    if index == SLSegmentedControlNoSegment {
      ...
      selectionIndicatorRoundedLayer.removeFromSuperlayer()
    } else {
      ...
      if animated {
        ...
        selectionIndicatorRoundedLayer.actions = nil
