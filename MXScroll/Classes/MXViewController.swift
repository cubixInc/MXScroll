...
public class MXViewController: BaseUIViewController {
  /// settting segment from outside
  open var segmentView: MSSegmentControl!

  var segmentedScrollView = MXScrollView<MSSegmentControl>(frame: CGRect.zero)
  ...
  open var segmentViewHeight: CGFloat = 40.0 {
    ...
    open var segmentLeftPadding: CGFloat = 0 {
      didSet {
        segmentedScrollView.segmentLeftPadding = segmentLeftPadding
      }
    }
  ...
  open var shouldScrollToBottomAtFirstTime: Bool = false {
    didSet {
